...
public class IntermediateOperations {
    ...
    public static void main(String[] args) {
        ...
        //-> you are trying to do something in the close pipeline.

        Arrays.asList("Apple", "Orange", "Kiwi", "Banana", "Apple", "Cherry", "Mango").stream()
                .filter(str -> str.equals("Apple")).forEach(str -> System.out.println(str));
        /*---output: Apple
                     Apple */

        System.out.println("**********MAP***********");
        Arrays.asList("Apple", "Orange", "Kiwi", "Banana", "Apple", "Cherry", "Mango").stream()
                .map(str -> str.toUpperCase()).forEach(str -> System.out.println(str));
        /*---output: APPLE
                     ORANGE
                     KIWI
                     BANANA
        ...
        Arrays.asList("Apple", "Orange", "Kiwi", "Banana", "Apple", "Cherry", "Mango").stream()
                .distinct().forEach(str -> System.out.println(str));
        /* ---output: Apple
                      Orange
                      Kiwi
                      Banana
